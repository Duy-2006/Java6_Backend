...
public interface UserRepository extends JpaRepository<User, Integer> {
	...
	int updateActiveStatus(@Param("username") String username, @Param("status") Boolean status);
	...
	@Query("SELECT COUNT(u) FROM User u WHERE u.role = 'USER' AND u.createdDate BETWEEN :start AND :end")
